                ...
                <div class="w-px-700 mx-auto">
                    <div id="multiStepsValidation" class="bs-stepper shadow-none">
                        ...
                        <div class="bs-stepper-content">
                            <form id="multiStepsForm" onSubmit="">
                                <!-- Account Details -->
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="multiStepsURL" id="multiStepsURL"
                                                class="form-control" placeholder="johndoe/profile" aria-label="johndoe" />
                                        </div>
                                            ...
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content" for="basicOption">
                                                    <span class="custom-option-body">
                                                        ...
                                                        <p class="mb-2">A simple start for start ups & Students
                                                        </p>
                                            ...
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <span class="custom-option-body">
                                                        ...
                                                        <p class="mb-2">Solution for enterprise & organizations
                                                        </p>
                                                        <span class="d-flex justify-content-center">
                                                            <sup class="text-primary fs-big lh-1 mt-3">$</sup>
