...
<!-- Mirrored from themeselection.com/demo/sneat-bootstrap-html-admin-template/html/horizontal-menu-template/auth-register-multisteps.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Feb 2022 02:19:56 GMT -->
    ...
    <div class="authentication-wrapper authentication-cover">
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-4 align-items-center justify-content-end p-5 pe-0">
                <div class="w-px-400">
                    <img src="{{ asset('img/illustrations/create-account-light.png') }}" class="img-fluid"
                                            ...
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <span class="custom-option-body">
                                                        ...
                                                        <p class="mb-2">A simple start for start ups &
                                                            Students</p>
                                            ...
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <span class="custom-option-body">
                                                        ...
                                                        <p class="mb-2">Solution for enterprise &
                                                            organizations</p>
                                                        <span class="d-flex justify-content-center">
                                                            <sup class="text-primary fs-big lh-1 mt-3">$</sup>
                                                            <span class="display-5 text-primary">499</span>
                                                            <sub
                                                                class="lh-1 fs-big mt-auto mb-2 text-muted">/year</sub>
                                                        </span>
                                                    </span>
                                                    <input name="customRadioIcon" class="form-check-input" type="radio"
...
<!-- Mirrored from themeselection.com/demo/sneat-bootstrap-html-admin-template/html/horizontal-menu-template/auth-register-multisteps.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Feb 2022 02:19:57 GMT -->
